...
export default class SolicitudService {
  find(id: string): Promise<ISolicitud> {
  ...
  create(entity: ISolicitud): Promise<ISolicitud> {
    return new Promise<ISolicitud>((resolve, reject) => {
      axios
  ...
  update(entity: ISolicitud): Promise<ISolicitud> {
    return new Promise<ISolicitud>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: ISolicitud): Promise<ISolicitud> {
    return new Promise<ISolicitud>((resolve, reject) => {
      axios
